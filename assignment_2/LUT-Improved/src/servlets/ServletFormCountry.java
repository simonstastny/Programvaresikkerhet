...
public class ServletFormCountry extends HttpServlet {
    ...
    public static final String VIEW_SUCCESS = "/Restricted/Admin/add_country.jsp";
    public static final String VIEW_FORM = "/Restricted/Admin/formAddCountrySchool.jsp";
